...
public class ObDbAdapter {
    ...
    public Cursor getSubcategoryDetailCursor(String subcategoryId) {
        ...
        String[] columnsToReturn = new String[] { BjcpSubcategoryColumns._ID,
                BjcpSubcategoryColumns.NAME, BjcpSubcategoryColumns.DISPLAY_ID,
                BjcpSubcategoryColumns.AROMA, BjcpSubcategoryColumns.APPEARANCE,
                BjcpSubcategoryColumns.FLAVOR, BjcpSubcategoryColumns.MOUTHFEEL,
                BjcpSubcategoryColumns.IMPRESSION, BjcpSubcategoryColumns.COMMENTS,
                BjcpSubcategoryColumns.INGREDIENTS, BjcpSubcategoryColumns.OG_LOW,
                BjcpSubcategoryColumns.OG_HIGH, BjcpSubcategoryColumns.FG_LOW,
                BjcpSubcategoryColumns.FG_HIGH, BjcpSubcategoryColumns.IBU_LOW,
                BjcpSubcategoryColumns.IBU_HIGH, BjcpSubcategoryColumns.SRM_LOW,
                BjcpSubcategoryColumns.SRM_HIGH, BjcpSubcategoryColumns.ABV_LOW,
                BjcpSubcategoryColumns.ABV_HIGH, BjcpSubcategoryColumns.EXAMPLES };

        String[] selectionCriteria = new String[] { subcategoryId };

        Cursor cursor = queryBuilder.query(mDb, columnsToReturn,
                BjcpSubcategoryColumns._ID + " = ?", selectionCriteria, null, null,
                null);
    ...
    public ColorPair getSrmColor(String srm) {
        ...
        if (cursor.moveToFirst()) {
            colors.backgroundColor = Color
                    .rgb(cursor
                            .getInt(cursor.getColumnIndex(SrmColorColumns.RED)),
                            cursor.getInt(cursor.getColumnIndex(SrmColorColumns.GREEN)),
                            cursor.getInt(cursor.getColumnIndex(SrmColorColumns.BLUE)));
            if (Integer.parseInt(srm) < 12.7) {
